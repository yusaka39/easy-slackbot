...
import io.github.yusaka39.easySlackbot.scheduler.AnnotationBasedScheduledTaskSetFactory
import io.github.yusaka39.easySlackbot.scheduler.Schedule
import io.github.yusaka39.easySlackbot.scheduler.ScheduledTask
import io.github.yusaka39.easySlackbot.test.scheduler.testTaskHolder.TestTaskHolder
...
class AnnotationBasedScheduledTaskSetFactoryTest {
    ...
    fun factoryReturnsExpectedSet() {
        ...
        val actual = AnnotationBasedScheduledTaskSetFactory(
                "io.github.yusaka39.easySlackbot.test.scheduler.testTaskHolder"
        ).create()
